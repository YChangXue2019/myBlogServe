...
select date(subdate(curdate(),date_format(curdate(),'%w')-1)) as today;-- 今天的日期

select  date(DATE_SUB(subdate(curdate(),date_format(curdate(),'%w')-1), interval 1 day)) as lastweek; -- 昨天的日期
